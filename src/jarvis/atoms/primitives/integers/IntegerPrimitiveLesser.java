...
//OPERATIONSPRIMITIVES
/*
 * Cette classe implante la partie de l'opération primitive spécifique de comparaison plus petit que.
 *
 */

public class IntegerPrimitiveLesser extends IntegerPrimitiveOperation {


    @Override
    public String makeKey() {

        return "IntegerPrimitiveLesser";
    }
