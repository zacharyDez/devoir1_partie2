...
//OPERATIONSPRIMITIVES
/*
 * Cette classe implante la partie de l'opération primitive spécifique de comparaison plus grand que.
 *
 */

public class IntegerPrimitiveGreater extends IntegerPrimitiveOperation {


    @Override
    public String makeKey() {

        return "IntegerPrimitiveGreater";
    }
